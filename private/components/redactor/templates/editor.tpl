...
<script src="[[+assetsUrl]]redactor-2.3.7.min.js"></script>
[[+plugin_files]]
...
<script type="text/javascript">
    ...
    $red(document).ready(function($) {
        ...
        redactorOptions.imageUploadErrorCallback = redactorOptions.fileUploadErrorCallback = function(json) {
            MODx.msg.alert(_('error'), json.message);
        };
        ...
        if (!MODx.loadRTE) {
            MODx.loadRTE = function(elements) {
                ...
                $(elements).each(function(){
                    ...
                    if (element.id === 'ta' && window.ContentBlocksWillRenderContent) {
