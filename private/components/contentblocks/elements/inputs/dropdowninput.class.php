...
class DropdownInput extends cbBaseInput {
    ...
    public function getFieldProperties(): array
    {
        return [
            ...
            [
                'key' => 'type_ahead',
                'fieldLabel' => $this->modx->lexicon('contentblocks.dropdown.search_enabled'),
                'xtype' => 'combo-boolean',
                'default' => $this->modx->lexicon('no'),
                'description' => $this->modx->lexicon('contentblocks.dropdown.search_enabled.description')
            ]
        ];
    }
