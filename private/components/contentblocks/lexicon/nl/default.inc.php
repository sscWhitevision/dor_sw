...
$_lang['setting_contentblocks.file_template_path'] = 'Pad voor @FILE templates';
$_lang['setting_contentblocks.file_template_path_desc'] = 'Een relatief pad, vanaf de bron van de gekozen media source in de "contentblocks.file_template_source" system setting, vanaf waar @FILE templates geladen zullen worden. Bijvoorbeeld bij een media source met basePath <code>core/elements/</code> en <code>contentblocks/</code> in deze system setting zal een template met <code>@FILE fields/heading.tpl</code> gelezen worden uit <code>core/elements/contentblocks/fields/heading.tpl</code>. Het is ten zeerste aan te raden templates in a niet-publiek-toegankelijke te plaatsen, zoals core/elements/.';
...
$_lang['contentblocks.fieldtype.multi_select'] = "Multi-select dropdown";
...
$_lang['contentblocks.checkbox.description'] = "Een simpel selectievakje.";
$_lang['contentblocks.colorpicker'] = 'Kleurkiezer';
$_lang['contentblocks.colorpicker.description'] = 'Kleurenkiezer widget, opent in een modal window.';
$_lang['contentblocks.color_picker.select'] = 'Kies kleur';
$_lang['contentblocks.color_picker.cancel'] = 'Annuleren';
$_lang['contentblocks.color_picker.current'] = 'Huidig';
$_lang['contentblocks.color_picker.preset_swatch_colors'] = 'Vooringestelde kleuren';
...
// Multi-Select
$_lang['contentblocks.multiselect'] = "Multi-select dropdown";
$_lang['contentblocks.multiselect.description'] = "Een dropdown waaruit meerdere opties gekozen kunnen worden.";
...
$_lang['contentblocks.rebuild_everything'] = "Alles";
$_lang['contentblocks.choose_context'] = "Kies een context";
$_lang['contentblocks.rebuild_all_contexts'] = "Content in alle contexten opnieuw bouwen";
...
$_lang['contentblocks.rebuild_content.exception'] = "[[+type]] fout getriggered tijdens het verwerken van #[[+id]] ([[+pagetitle]]): [[+message]]";
...
$_lang['setting_contentblocks.crop_jpeg_quality'] = 'Uitsnede kwaliteit (voor JPEG)';
$_lang['setting_contentblocks.crop_jpeg_quality_desc'] = 'De JPEG kwaliteit om te gebruiken voor genereerde uitsneden. Dit is een numerieke waarde tussen 1 en 100.';
$_lang['setting_contentblocks.crop_png_compression'] = 'Uitsnede compressie (voor PNG)';
$_lang['setting_contentblocks.crop_png_compression_desc'] = 'De PNG compressie om te gebruiken voor gegeneerde uitsneden. Dit is een numerieke waarde tussen 1 en 10.';
