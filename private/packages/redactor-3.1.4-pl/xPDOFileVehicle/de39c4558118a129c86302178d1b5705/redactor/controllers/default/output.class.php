...
class RedactorOutputManagerController extends modExtraManagerController
{
    ...
    public function process(array $scriptProperties = array())
    {
        ...
        // Resource/context-specific values
        if (!empty($scriptProperties['resource']) && is_numeric($scriptProperties['resource'])) {
            $this->redactor->setResource((int)$scriptProperties['resource']);
        }
        if (!empty($scriptProperties['wctx']) && is_string($scriptProperties['wctx']) && !$this->redactor->getWorkingContext()) {
            $this->redactor->setWorkingContext($scriptProperties['wctx']);
        }
