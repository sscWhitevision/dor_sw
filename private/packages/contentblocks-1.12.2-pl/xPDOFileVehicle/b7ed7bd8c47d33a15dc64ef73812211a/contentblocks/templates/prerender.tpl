...
<script type="text/x-tmpl" id="contentblocks-modal-add-content-field">
    <li data-input-type="{%=o.input%}" class="tooltip" data-powertip="{%=o.description%}">
        <div class="thumbnail">
          <a href="javascript:void(0);" data-id="{%=o.id%}" >
            <img src="{%=o.icon%}" alt="{%=o.description%}">
          </a>
        </div>
        <div class="meta">
            <h3><a href="javascript:void(0);" data-id="{%=o.id%}">{%=o.name%}</a></h3>
            {% if (o.description) { %}
...
<div class="contentblocks-modal-field contentblocks-setting-select" id="{%=o.settingInstance%}-setting-{%=o.reference%}">
    <label class="field-label" for="{%=o.settingInstance%}-setting-{%=o.reference%}-input">{%=o.title%}</label>
    <select data-name="{%=o.reference%}" id="{%=o.settingInstance%}-setting-{%=o.reference%}-input" style="width: 70%;">
        {%#o.options%}
    </select>
    <p class="contentblocks-setting-description">{%=o.description%}</p>
</div>
</script>
...
<script type="text/x-tmpl" id="contentblocks-modal-layout-setting-multi_select">
<div class="contentblocks-modal-field contentblocks-setting-multi_select" id="{%=o.settingInstance%}-setting-{%=o.reference%}">
    <label class="field-label" for="{%=o.settingInstance%}-setting-{%=o.reference%}-input">{%=o.title%}</label>
    <select multiple data-name="{%=o.reference%}" id="{%=o.settingInstance%}-setting-{%=o.reference%}-input" style="width: 70%;">
        {%#o.options%}
    </select>
    <p class="contentblocks-setting-description">{%=o.description%}</p>
</div>
</script>
<script type="text/x-tmpl" id="contentblocks-modal-layout-setting-multi_select-option">
    <option value="{%=o.value%}" {%=o.selected%}>{%=o.display%}</option>
</script>
...
<script type="text/x-tmpl" id="contentblocks-modal-layout-setting-color_picker">
<div class="contentblocks-modal-field contentblocks-setting-color_picker" id="{%=o.settingInstance%}-setting-{%=o.reference%}">
    <label class="field-label" for="setting-{%=o.reference%}">{%=o.title%}</label>
    <button id="{%=o.settingInstance%}-color-picker-button-{%=o.reference%}"
            class="setting-color-picker-button"
            type="button"
            data-color="{%=o.value%}"
            data-reference="{%=o.reference%}"
            style="background-color:{% if (o.value) { %}{%=o.value%}{% }else{ %}#fafafa{% }%};"
    >
        <span id="{%=o.settingInstance%}-color-picker-code" class="color-picker-code">
            {% if (o.value) { %}
                {%=o.value%}
            {% } else { %}
                #fafafa
...
<div class="contentblocks-modal-field">
    ...
    <p class="contentblocks-setting-description contentblocks-setting-full-width">{%=o.description%}</p>
</div>
</script>
...
<script type="text/x-tmpl" id="contentblocks-modal-add-layout-option">
    <li class="tooltip" data-powertip="{%=o.description%}">
        <div class="thumbnail">
            <a href="javascript:void(0);" data-id="{%=o.id%}">
                <img src="{%=o.icon%}" alt="{%=o.description%}">
            </a>
