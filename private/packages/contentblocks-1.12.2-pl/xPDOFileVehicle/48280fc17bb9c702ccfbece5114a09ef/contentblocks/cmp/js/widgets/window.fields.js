ContentBlocksComponent.window.Field = function(config) {
    ...
    config.record.template = config.record.template || '';
...
Ext.extend(ContentBlocksComponent.window.Field, MODx.Window, {
    ...
    getGeneralItems: function(config) {
        var items = [{
            ...
            description: _('contentblocks.description_tooltip'),
            allowBlank: true,
            anchor: '100%',
            maxLength: 1024
        },{
            xtype: 'textarea',
            cls: 'cb-field-content-desc',
            name: 'content_desc',
            fieldLabel: _('contentblocks.content_description'),
            description: _('contentblocks.content_description_tooltip'),
            allowBlank: true,
            anchor: '100%',
        },{
