        ...
        return {
            init: function () {
                if (data.properties && ContentBlocks.toBoolean(data.properties.use_tinyrte)) {
                    ...
                    setTimeout(function() {
                        var resizer = window.autosize(dom.find('.contentblocks-field-textarea textarea'));
                        resizer.on('autosize:resized', ContentBlocks.fixColumnHeights);
                    }, 100);
                }
            },
            getData: function () {
        ...
        return {
            init: function () {
                ...
                if (MODx.loadRTE) {
                    ...
                    setTimeout(function() {
                        var resizer = window.autosize(textarea);
                        resizer.on('autosize:resized', ContentBlocks.fixColumnHeights);
                    }, 100);
                }
