					...
					this.opts.modal = {
						...
						+ '<section id="redactor-modal-image-edit">'
							...
							+ '<select class="redactor-image-position-option" id="redactor-image-align" aria-label="' + this.lang.get('image_position') + '">'
								...
								+ '<option value="left">' + this.lang.get('align_left') + '</option>'
								+ '<option value="center">' + this.lang.get('align_center') + '</option>'
								+ '<option value="right">' + this.lang.get('align_right') + '</option>'
							+ '</select>'
						+ '</section>',
